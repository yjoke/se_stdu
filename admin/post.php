...
<?php
$sql = "select * from posts join users on posts.user_id = users.user_id where del_flag = 0";
...
?>
	<th>
	    <button type="button" onclick="skip('postInfo.php?post_id=<?php echo $row["post_id"] ?>')">查看</button>
	    <button type="button" onclick='delPost("<?php echo $i ?>")'>删除</button>
    </th>
<?php
// 	$i++;
	echo "</tr>";
